...
public class SatanicBibleWisp extends SoulWisp {
    public static final String ID = IsaacModExtend.makeID("SatanicBibleWisp");
    public static final String NAME;

    public SatanicBibleWisp() {
        super();
        this.name = NAME;
        this.id = ID;
    }
    ...
    protected Texture loadImage() {
        return new Texture(IsaacModExtend.getResourcePath("monsters/satanicBibleWisp.png"));
    }
