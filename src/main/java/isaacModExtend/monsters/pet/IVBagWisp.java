...
public class IVBagWisp extends SoulWisp {
    public static final String ID = IsaacModExtend.makeID("IVBagWisp");
    ...
    protected Texture loadImage() {
        return new Texture(IsaacModExtend.getResourcePath("monsters/ivBagWisp.png"));
    }
